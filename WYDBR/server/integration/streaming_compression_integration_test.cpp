/**
 * @file streaming_compression_integration_test.cpp
 * @brief Teste de integração entre os sistemas streaming e compression
 */
...
#include "compression/compression-system.h"

/**
 * @brief Classe de teste de integração entre streaming e compression
 */
class StreamingCompressionIntegrationTest {
public:
    /**
     ...
     */
    bool runAllTests() {
        std::cout << "Executando testes de integração entre streaming e compression..." << std::endl;
        ...
        if (result) {
            std::cout << "✓ Todos os testes de integração entre streaming e compression passaram!" << std::endl;
        } else {
            std::cerr << "✗ Falha nos testes de integração entre streaming e compression!" << std::endl;
        }
 ...
 */
int main() {
    StreamingCompressionIntegrationTest tester;
