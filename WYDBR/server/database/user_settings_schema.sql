...
-- Tabela para teclas de atalho personalizadas (adicionada automaticamente)
...
-- Tabela para lista de amigos (adicionada automaticamente)
...
-- Tabela para usuários bloqueados (adicionada automaticamente)
