 ...
 * @brief Benchmark de desempenho para o sistema memory
 */
 ...
 * @brief Benchmark para o sistema memory
 */
class MemoryBenchmark {
public:
    /**
    ...
    void runAllBenchmarks() {
        std::cout << "Executando benchmarks para memory..." << std::endl;
        
        // Inicializar o sistema
        wydbr::memory::MemorySystem system;
        system.Initialize();
        ...
        std::cout << "✓ Benchmarks concluídos para memory!" << std::endl;
    }
...
private:
     ...
     */
    std::map<std::string, double> benchmarkMainOperations(wydbr::memory::MemorySystem& system, int size) {
    ...
    void saveResults(int size, const std::map<std::string, double>& results) {
        std::string filename = "./WYDBR/server/benchmarks/memory_benchmark_results.csv";
