 ...
 * @brief Benchmark de desempenho para o sistema streaming
 */
 ...
 * @brief Benchmark para o sistema streaming
 */
class StreamingBenchmark {
public:
    /**
    ...
    void runAllBenchmarks() {
        std::cout << "Executando benchmarks para streaming..." << std::endl;
        
        // Inicializar o sistema
        wydbr::streaming::StreamingSystem system;
        system.Initialize();
        ...
        std::cout << "✓ Benchmarks concluídos para streaming!" << std::endl;
    }
...
private:
     ...
     */
    std::map<std::string, double> benchmarkMainOperations(wydbr::streaming::StreamingSystem& system, int size) {
    ...
    void saveResults(int size, const std::map<std::string, double>& results) {
        std::string filename = "./WYDBR/server/benchmarks/streaming_benchmark_results.csv";
