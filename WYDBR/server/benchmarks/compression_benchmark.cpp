 ...
 * @brief Benchmark de desempenho para o sistema compression
 */
 ...
 * @brief Benchmark para o sistema compression
 */
class CompressionBenchmark {
public:
    /**
    ...
    void runAllBenchmarks() {
        std::cout << "Executando benchmarks para compression..." << std::endl;
        
        // Inicializar o sistema
        wydbr::compression::CompressionSystem system;
        system.Initialize();
        ...
        std::cout << "✓ Benchmarks concluídos para compression!" << std::endl;
    }
...
private:
     ...
     */
    std::map<std::string, double> benchmarkMainOperations(wydbr::compression::CompressionSystem& system, int size) {
    ...
    void saveResults(int size, const std::map<std::string, double>& results) {
        std::string filename = "./WYDBR/server/benchmarks/compression_benchmark_results.csv";
