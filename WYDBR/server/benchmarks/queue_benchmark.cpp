 ...
 * @brief Benchmark de desempenho para o sistema queue
 */
 ...
 * @brief Benchmark para o sistema queue
 */
class QueueBenchmark {
public:
    /**
    ...
    void runAllBenchmarks() {
        std::cout << "Executando benchmarks para queue..." << std::endl;
        
        // Inicializar o sistema
        wydbr::queue::QueueSystem system;
        system.Initialize();
        ...
        std::cout << "✓ Benchmarks concluídos para queue!" << std::endl;
    }
...
private:
     ...
     */
    std::map<std::string, double> benchmarkMainOperations(wydbr::queue::QueueSystem& system, int size) {
    ...
    void saveResults(int size, const std::map<std::string, double>& results) {
        std::string filename = "./WYDBR/server/benchmarks/queue_benchmark_results.csv";
