/**
 * @file adaptive-compressor_test.cpp
 * @brief Testes unitários para o componente adaptive-compressor
 */
...
/**
 * @brief Classe de teste para adaptive-compressor
 */
class Adaptive-compressorTest {
public:
    /**
     ...
     */
    bool runAllTests() {
        std::cout << "Executando testes para adaptive-compressor..." << std::endl;
        ...
        if (result) {
            std::cout << "✓ Todos os testes de adaptive-compressor passaram com sucesso!" << std::endl;
        } else {
            std::cerr << "✗ Falha nos testes de adaptive-compressor!" << std::endl;
        }
...
private:
    ...
    bool testBasicInitialization() {
        ...
        wydbr::compression::Adaptive-compressor instance;
 ...
 */
int main() {
    Adaptive-compressorTest tester;
