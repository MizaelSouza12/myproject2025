/**
 * @file validator-factory_test.cpp
 * @brief Testes unitários para o componente validator-factory
 */
...
#include "validation/validator-factory.h"

/**
 * @brief Classe de teste para validator-factory
 */
class Validator-factoryTest {
public:
    /**
     ...
     */
    bool runAllTests() {
        std::cout << "Executando testes para validator-factory..." << std::endl;
        ...
        if (result) {
            std::cout << "✓ Todos os testes de validator-factory passaram com sucesso!" << std::endl;
        } else {
            std::cerr << "✗ Falha nos testes de validator-factory!" << std::endl;
        }
...
private:
    ...
    bool testBasicInitialization() {
        ...
        wydbr::validation::Validator-factory instance;
