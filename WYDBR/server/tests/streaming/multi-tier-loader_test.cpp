/**
 * @file multi-tier-loader_test.cpp
 * @brief Testes unitários para o componente multi-tier-loader
 */
...
#include "streaming/multi-tier-loader.h"

/**
 * @brief Classe de teste para multi-tier-loader
 */
class Multi-tier-loaderTest {
public:
    /**
     ...
     */
    bool runAllTests() {
        std::cout << "Executando testes para multi-tier-loader..." << std::endl;
        ...
        if (result) {
            std::cout << "✓ Todos os testes de multi-tier-loader passaram com sucesso!" << std::endl;
        } else {
            std::cerr << "✗ Falha nos testes de multi-tier-loader!" << std::endl;
        }
...
private:
    ...
    bool testBasicInitialization() {
        ...
        wydbr::streaming::Multi-tier-loader instance;
