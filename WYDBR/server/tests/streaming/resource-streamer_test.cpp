/**
 * @file resource-streamer_test.cpp
 * @brief Testes unitários para o componente resource-streamer
 */
...
/**
 * @brief Classe de teste para resource-streamer
 */
class Resource-streamerTest {
public:
    /**
     ...
     */
    bool runAllTests() {
        std::cout << "Executando testes para resource-streamer..." << std::endl;
        ...
        if (result) {
            std::cout << "✓ Todos os testes de resource-streamer passaram com sucesso!" << std::endl;
        } else {
            std::cerr << "✗ Falha nos testes de resource-streamer!" << std::endl;
        }
...
private:
    ...
    bool testBasicInitialization() {
        ...
        wydbr::streaming::Resource-streamer instance;
